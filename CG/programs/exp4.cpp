/*
Title:Draw a 4*4 chessboard rotated 45? with the horizontal axis. Use Bresenham algorithm to draw all the lines. Use seed fill algorithm to fill black squares of the rotated chessboard.
Name:Pratik Gupta
Class:SE
Roll no:26
D.o.P:
